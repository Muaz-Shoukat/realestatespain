    ...
    try {
      const response = await fetch(
        "https://realestate-server-cyan.vercel.app/detail",
        {
          method: "post",
          body: JSON.stringify({
            url: `https://www.pisos.com/${decodeData}`,
          }),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center mb-4 text-md">
                  ...
                  <h6 className="ml-2 font-semibold">{data.number}</h6>
                </div>
                ...
                <div className="mb-6 text-sm">
                  ...
                  <h5 className="my-4">{data.basicData}</h5>
                  <h5 className="my-4">{data.equips}</h5>
                </div>

                <div className="mb-4 text-sm">
                  <span className="text-[#7D879C]">Detail:</span>
                  <h6 className="text-xs">{data.detail}</h6>
                </div>
              </div>
            </div>
          </div>
